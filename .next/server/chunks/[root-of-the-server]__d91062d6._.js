module.exports = [
"[project]/.next-internal/server/app/api/ai/tuning/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/ai/tuning/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        let systemContent = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$agent$2d$engine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TUNING_SYSTEM_PROMPT"];
        ...
        if (voiceProfile && Object.keys(voiceProfile).length > 0) {
            const obs = voiceProfile.style_observations || [];
            const moves = voiceProfile.signature_moves || [];
            const avoid = voiceProfile.avoid || [];
...
When rewriting, humanizing, or generating any content for this user, apply every observation above. The goal: output they could post without changing a word.`;
        ...
        const model = selectedModel || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$agent$2d$engine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_MODEL"];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d91062d6._.js.map