...
"[project]/src/app/dashboard/meta/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateSessionName(firstMsg) {
    ...
    if (foundPlatform && foundType) return "".concat(foundPlatform.charAt(0).toUpperCase() + foundPlatform.slice(1), " ").concat(types[foundType]);
    if (foundPlatform) return "".concat(foundPlatform.charAt(0).toUpperCase() + foundPlatform.slice(1), " Content");
    if (foundType) return "".concat(types[foundType], " Craft");
    const t = firstMsg.slice(0, 28).trim();
    return "".concat(t).concat(firstMsg.length > 28 ? "..." : "");
}
...
async function speakText(text, onEnd) {
    ...
    if ("speechSynthesis" in window) {
        ...
        u.onend = ()=>onEnd === null || onEnd === void 0 ? void 0 : onEnd();
        u.onerror = ()=>onEnd === null || onEnd === void 0 ? void 0 : onEnd();
...
function MetaPage() {
    ...
    const [voiceMode, setVoiceMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [voiceMessages, setVoiceMessages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const voiceAudioRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const voiceMsgsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MetaPage.useEffect": ()=>{
            voiceMsgsRef.current = voiceMessages;
        }
    }["MetaPage.useEffect"], [
        voiceMessages
    ]);
    const persistSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MetaPage.useCallback[persistSession]": (msgs, sid)=>{
            if (msgs.length === 0) return;
            setSessions({
                "MetaPage.useCallback[persistSession]": (prev)=>{
                    const exists = prev.find({
                        "MetaPage.useCallback[persistSession].exists": (s)=>s.id === sid
                    }["MetaPage.useCallback[persistSession].exists"]);
                    let next;
                    if (exists) {
                        next = prev.map({
                            "MetaPage.useCallback[persistSession]": (s)=>s.id === sid ? {
                                    ...s,
                                    messages: msgs
                                } : s
                        }["MetaPage.useCallback[persistSession]"]);
                    } else {
                        const first = msgs.find({
                            "MetaPage.useCallback[persistSession].first": (m)=>m.role === "user"
                        }["MetaPage.useCallback[persistSession].first"]);
                        next = [
                            {
                                id: sid,
                                name: first ? generateSessionName(first.content) : "New Chat",
    ...
    const handleSpeak = async (msg)=>{
        var _audioRef_current, _window_speechSynthesis;
        if (speakingId === msg.id) {
            var _audioRef_current1, _window_speechSynthesis1;
            (_audioRef_current1 = audioRef.current) === null || _audioRef_current1 === void 0 ? void 0 : _audioRef_current1.pause();
            audioRef.current = null;
            (_window_speechSynthesis1 = window.speechSynthesis) === null || _window_speechSynthesis1 === void 0 ? void 0 : _window_speechSynthesis1.cancel();
            setSpeakingId(null);
            return;
        }
        (_audioRef_current = audioRef.current) === null || _audioRef_current === void 0 ? void 0 : _audioRef_current.pause();
        audioRef.current = null;
        (_window_speechSynthesis = window.speechSynthesis) === null || _window_speechSynthesis === void 0 ? void 0 : _window_speechSynthesis.cancel();
        setSpeakingId(msg.id);
        const audio = await speakText(msg.content, ()=>setSpeakingId(null));
        if (audio) audioRef.current = audio;
    };
    const callMeta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MetaPage.useCallback[callMeta]": async (userText, history)=>{
    ...
    const send = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MetaPage.useCallback[send]": async ()=>{
            ...
            try {
                const history = messages.map({
                    "MetaPage.useCallback[send].history": (m)=>({
                            role: m.role === "bot" ? "assistant" : "user",
                            content: m.content
                        })
                }["MetaPage.useCallback[send].history"]);
    ...
    const handleVoiceInput = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MetaPage.useCallback[handleVoiceInput]": async ()=>{
            if (listening) {
                var _recorderRef_current;
                (_recorderRef_current = recorderRef.current) === null || _recorderRef_current === void 0 ? void 0 : _recorderRef_current.stop();
                return;
            }
            try {
                ...
                recorder.ondataavailable = ({
                    "MetaPage.useCallback[handleVoiceInput]": (e)=>{
                        if (e.data.size > 0) chunks.push(e.data);
                    }
                })["MetaPage.useCallback[handleVoiceInput]"];
                recorder.onstop = ({
                    "MetaPage.useCallback[handleVoiceInput]": async ()=>{
                        stream.getTracks().forEach({
                            "MetaPage.useCallback[handleVoiceInput]": (t)=>t.stop()
                        }["MetaPage.useCallback[handleVoiceInput]"]);
                        ...
                        try {
                            ...
                            if (res.ok) {
                                ...
                                if (d.text) setInput({
                                    "MetaPage.useCallback[handleVoiceInput]": (prev)=>prev + d.text
                                }["MetaPage.useCallback[handleVoiceInput]"]);
                            }
                        } catch (e) {}
                        setListening(false);
                ...
                r.onerror = ({
                    "MetaPage.useCallback[handleVoiceInput]": ()=>setListening(false)
                })["MetaPage.useCallback[handleVoiceInput]"];
                r.onend = ({
                    "MetaPage.useCallback[handleVoiceInput]": ()=>setListening(false)
                })["MetaPage.useCallback[handleVoiceInput]"];
    ...
    const stopVoiceConversation = ()=>{
        var _voiceAudioRef_current, _recorderRef_current, _window_speechSynthesis;
        (_voiceAudioRef_current = voiceAudioRef.current) === null || _voiceAudioRef_current === void 0 ? void 0 : _voiceAudioRef_current.pause();
    ...
    const voiceListen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MetaPage.useCallback[voiceListen]": async ()=>{
            if (voiceState !== "idle") return;
            setVoiceState("listening");
            setVoiceTranscript("");
            const recordAndTranscribe = {
                "MetaPage.useCallback[voiceListen].recordAndTranscribe": async ()=>{
                    try {
                        const stream = await navigator.mediaDevices.getUserMedia({
                            audio: true
                        });
                        ...
                        recorderRef.current = recorder;
                        recorder.ondataavailable = ({
                            "MetaPage.useCallback[voiceListen].recordAndTranscribe": (e)=>{
                                if (e.data.size > 0) chunks.push(e.data);
                            }
                        })["MetaPage.useCallback[voiceListen].recordAndTranscribe"];
                        recorder.onstop = ({
                            "MetaPage.useCallback[voiceListen].recordAndTranscribe": async ()=>{
                                stream.getTracks().forEach({
                                    "MetaPage.useCallback[voiceListen].recordAndTranscribe": (t)=>t.stop()
                                }["MetaPage.useCallback[voiceListen].recordAndTranscribe"]);
                                const blob = new Blob(chunks, {
                                    type: "audio/webm"
                                });
                                ...
                                try {
                                    const history = voiceMsgsRef.current.slice(0, -1).map({
                                        "MetaPage.useCallback[voiceListen].recordAndTranscribe.history": (m)=>({
                                                role: m.role === "bot" ? "assistant" : "user",
                                                content: m.text
                                            })
                                    }["MetaPage.useCallback[voiceListen].recordAndTranscribe.history"]);
                                    const res = await fetch("/api/ai/meta", {
                                        method: "POST",
                                        headers: {
                                            "Content-Type": "application/json"
                                    ...
                                    const audio = await speakText(reply, {
                                        "MetaPage.useCallback[voiceListen].recordAndTranscribe": ()=>setVoiceState("idle")
                                    }["MetaPage.useCallback[voiceListen].recordAndTranscribe"]);
                        ...
                        }["MetaPage.useCallback[voiceListen].recordAndTranscribe"], 8000);
                    } catch (e) {
                        setVoiceState("idle");
                    }
                }
    ...
    }["MetaPage.useCallback[voiceListen]"], [
        voiceState
    ]);
    const handleFileChange = (e)=>{
        if (e.target.files) setAttachedFiles((prev)=>[
                ...prev,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                children: voiceMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    initial: {
                        opacity: 0
                    },
                    animate: {
                    ...
                    style: {
                        background: "linear-gradient(160deg, #0f0f1a 0%, #1a0a14 50%, #0a0f1a 100%)"
                    },
                    children: [
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$phone$2d$off$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__PhoneOff$3e$__["PhoneOff"], {
                                        ...
                                        fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                        lineNumber: 357,
                                        columnNumber: 17
                                    }, this),
                                    " End Call"
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex-1 w-full max-w-lg overflow-y-auto px-6 flex flex-col gap-3 justify-end pb-4",
                            children: [
                                voiceMessages.map((m, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                        initial: {
                                            opacity: 0,
                                            y: 10
                                        },
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: m.text.length > 200 ? m.text.slice(0, 200) + "…" : m.text
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                            lineNumber: 370,
                                            columnNumber: 19
                                ...
                                voiceTranscript && voiceState === "listening" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                                    ...
                                    whileHover: voiceState === "idle" ? {
                                        scale: 1.06
                                    } : {},
                                    whileTap: voiceState === "idle" ? {
                                        scale: 0.94
                                    } : {},
                                    ...
                                    style: {
                                        ...
                                        height: 88,
                                        borderRadius: "50%",
                                        background: voiceState === "listening" ? "radial-gradient(circle, rgba(244,63,94,0.9), rgba(244,63,94,0.5))" : voiceState === "speaking" ? "radial-gradient(circle, rgba(139,92,246,0.9), rgba(139,92,246,0.5))" : "radial-gradient(circle, rgba(255,255,255,0.12), rgba(255,255,255,0.04))",
                                        border: voiceState === "idle" ? "2px solid rgba(255,255,255,0.15)" : "none",
                                        boxShadow: voiceState === "listening" ? "0 0 0 12px rgba(244,63,94,0.12), 0 0 0 24px rgba(244,63,94,0.06)" : voiceState === "speaking" ? "0 0 0 12px rgba(139,92,246,0.12), 0 0 0 24px rgba(139,92,246,0.06)" : "0 0 0 1px rgba(255,255,255,0.1)"
                                    },
                                    children: voiceState === "thinking" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                        size: 28,
                                        ...
                                        lineNumber: 425,
                                        columnNumber: 19
                                    }, this) : voiceState === "speaking" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$waves$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Waves$3e$__["Waves"], {
                                        size: 28,
                                        style: {
                                        ...
                                        size: 28,
                                        style: {
                                            color: voiceState === "listening" ? "#fff" : "rgba(255,255,255,0.6)"
                                        }
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                        lineNumber: 429,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: voiceState === "idle" ? "Tap mic • Auto-stops after 8 seconds" : voiceState === "speaking" ? "AI is speaking…" : ""
                                }, void 0, false, {
                                    fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                    lineNumber: 433,
                                    columnNumber: 15
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "h-full flex overflow-hidden mesh-bg",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                                        ...
                                        style: {
                                            background: "linear-gradient(135deg, rgba(244,63,94,0.85), rgba(249,115,22,0.85))",
                                            color: "#fff",
                                            fontSize: 12,
                                            letterSpacing: "0.02em",
                                            boxShadow: "0 3px 10px rgba(244,63,94,0.22)"
                                        },
                                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: sessions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    lineNumber: 470,
                                    columnNumber: 15
                                }, this) : sessions.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                        onClick: ()=>loadSession(s),
                                        className: "relative group mb-0.5 px-2.5 py-2 rounded-lg cursor-pointer flex flex-col",
                                        style: {
                                            background: activeId === s.id ? "rgba(244,63,94,0.08)" : "transparent",
                                            border: activeId === s.id ? "1px solid rgba(244,63,94,0.15)" : "1px solid transparent"
                                        },
                                        whileHover: {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-black/75 truncate",
                                                style: {
                                                    fontSize: 12,
                                                    fontWeight: 600,
                                                    lineHeight: 1.3
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-black/30 mt-0.5",
                                                style: {
                                                    fontSize: 10
                                                },
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                style: {
                                    background: "linear-gradient(135deg, rgba(255,255,255,0.65), rgba(255,245,250,0.55), rgba(255,255,255,0.6))",
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        style: {
                                            background: "linear-gradient(120deg, rgba(255,255,255,0.55), rgba(255,255,255,0), rgba(255,200,220,0.15))",
                                            mixBlendMode: "screen"
                                        }
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: "AI Copywriter — drop a seed or idea"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                                        lineNumber: 510,
                                                        columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    messages.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex-1 flex flex-col items-center justify-center text-center px-8 pt-8",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Drop a content seed, raw idea, or topic. Meta writes three platform-ready variations that sound like you."
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                                lineNumber: 522,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    "Write a LinkedIn post about my SaaS launch",
                                                    "Twitter thread on lessons learned",
                                                    "Instagram caption for my journey"
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        style: {
                                                            fontSize: 15,
                                                            color: msg.role === "user" ? "#fff" : "rgba(0,0,0,0.78)"
                                                        },
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                style: {
                                                                    fontSize: 10,
                                                                    color: msg.role === "user" ? "rgba(255,255,255,0.3)" : "rgba(0,0,0,0.2)"
                                                                },
                                                            ...
                                                            msg.role === "bot" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                className: "flex items-center gap-1 rounded-lg px-2 py-0.5 transition-all hover:bg-black/5",
                                                                style: {
                                                                    opacity: 0.6
                                                                },
                                                                title: "Read aloud",
                            ...
                            attachedFiles.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "px-6 pb-2 flex flex-wrap gap-2 flex-shrink-0",
                                children: attachedFiles.map((f, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    style: {
                                        ...
                                        boxShadow: "0 8px 32px rgba(244,63,94,0.12), 0 4px 16px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,1)"
                                    },
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "absolute inset-0 pointer-events-none",
                                            style: {
                                                background: "linear-gradient(135deg, rgba(255,255,255,0.5), rgba(255,255,255,0), rgba(255,200,220,0.1))",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    className: "flex-shrink-0 w-8 h-8 rounded-xl flex items-center justify-center hover:bg-black/5 transition-colors mb-0.5",
                                                    title: "Attach file",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$paperclip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Paperclip$3e$__["Paperclip"], {
                                                        size: 15,
                                                        className: attachedFiles.length > 0 ? "text-rose-500" : "text-black/30"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                                        lineNumber: 589,
                                                        columnNumber: 19
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$mic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Mic$3e$__["Mic"], {
                                                        size: 15,
                                                        className: listening ? "text-red-400 animate-pulse" : "text-black/30"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                                        lineNumber: 599,
                                                        columnNumber: 19
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                                                    ...
                                                    style: {
                                                        background: input.trim() && !loading ? "linear-gradient(135deg, #f43f5e, #f97316)" : "rgba(0,0,0,0.07)",
                                                        boxShadow: input.trim() && !loading ? "0 4px 16px rgba(244,63,94,0.35), 0 2px 6px rgba(0,0,0,0.1)" : "none",
                                                        transition: "all 0.2s"
                                                    },
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowUp$3e$__["ArrowUp"], {
                                                        size: 15,
                                                        style: {
                                                            color: input.trim() && !loading ? "#fff" : "rgba(0,0,0,0.25)"
                                                        }
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/meta/page.tsx",
                                                        lineNumber: 606,
...
_s(MetaPage, "G/fUTc2xvY1WNHWXfYPsmroVjyk=");
_c = MetaPage;
var _c;
__turbopack_context__.k.register(_c, "MetaPage");
...
//# sourceMappingURL=_a86fd9d5._.js.map