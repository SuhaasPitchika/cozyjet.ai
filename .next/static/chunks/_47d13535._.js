...
function generateSnooksName(firstMsg) {
    ...
    return "".concat(firstMsg.slice(0, 28)).concat(firstMsg.length > 28 ? "..." : "");
}
...
function CalendarGrid(param) {
    let { year, month, notes, onNoteClick } = param;
...
function SnooksPage() {
    ...
    const [notes, setNotes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(INITIAL_NOTES);
    const INIT_MSG = {
        id: "init",
        role: "bot",
    ...
    const send = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SnooksPage.useCallback[send]": async (text)=>{
            ...
            if (isAutoRequest(msg)) {
                ...
                setNotes({
                    "SnooksPage.useCallback[send]": (prev)=>[
                            ...prev.filter({
                                "SnooksPage.useCallback[send]": (n)=>n.day !== day
                ...
                const botMsg = {
                    ...
                    role: "bot",
                    content: "Done! I've auto-scheduled \"".concat(newNote.title, '" to day ').concat(day, " of your calendar. You'll see a green pin on that date."),
                    timestamp: new Date()
                };
                const all = [
                    ...next,
...
//# sourceMappingURL=_47d13535._.js.map