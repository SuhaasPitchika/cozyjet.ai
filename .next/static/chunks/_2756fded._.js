...
"[project]/src/app/dashboard/snooks/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
/* ─── Storage keys ─── */ const SNOOKS_SESSIONS_KEY = "snooks_sessions";
const SNOOKS_NOTES_KEY = "snooks_cal_notes";
/* ─── Session helpers ─── */ function generateSnooksName(firstMsg) {
    ...
    return found ? topics[found] : "".concat(firstMsg.slice(0, 28)).concat(firstMsg.length > 28 ? "..." : "");
}
...
function saveSessions(s) {
    try {
        localStorage.setItem(SNOOKS_SESSIONS_KEY, JSON.stringify(s));
    } catch (e) {}
}
/* ─── Note storage ─── */ const DEFAULT_NOTES = (()=>{
    const now = new Date();
    ...
    return [
        {
            ...
            year: y,
            title: "LinkedIn Post",
            text: "Ship the new auth feature post — include the JWT diagram screenshot.",
            auto: false
        },
        {
            id: "d2",
            ...
            text: "5-tweet thread on building in public. Hook: 'I shipped to 0 users today.'",
            auto: false
        },
        {
            id: "d3",
            ...
            year: y,
            title: "Notion Update",
            text: "Q2 roadmap → LinkedIn carousel. Each slide = 1 feature with a concrete benefit.",
            auto: false
        },
        {
            id: "d4",
            ...
            year: y,
            title: "Content Batch",
            text: "Monday batch day. Schedule 3 posts for the week. Focus: Tue/Thu morning slots.",
            auto: false
        },
        {
            id: "d5",
            ...
            year: y,
            title: "Monthly Wrap",
            text: "End-of-month recap. What shipped, what failed, what surprised you.",
            auto: false
        }
    ];
})();
...
function saveNotes(n) {
    try {
        localStorage.setItem(SNOOKS_NOTES_KEY, JSON.stringify(n));
    } catch (e) {}
}
/* ─── Date parsing ─── */ const MONTH_NAMES = [
    "january",
    "february",
    "march",
    "april",
...
function parseCalendarIntent(msg) {
    ...
    const finalDay = day !== null && day !== void 0 ? day : Math.floor(Math.random() * 28) + 1;
    const cleaned = msg.replace(/\b(add to calendar|schedule|set a note|auto|remind me|note for|note on|post on|post this|on\s+(?:the\s+)?\d{1,2}(?:st|nd|rd|th)?|next\s+\w+|this\s+\w+|monday|tuesday|wednesday|thursday|friday|saturday|sunday)/gi, "").trim();
...
/* ─── CalendarGrid ─── */ function CalendarGrid(param) {
    let { year, month, notes, onNoteClick, onDayClick } = param;
    ...
    const dayNotes = (day)=>notes.filter((n)=>n.day === day && n.month === month && n.year === year);
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: day !== null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex flex-col gap-px mt-1 overflow-hidden",
                                    children: [
                                        notes4day.slice(0, 2).map((n)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: (e)=>{
                                                    e.stopPropagation();
                                                    onNoteClick(n);
                                                },
                                                ...
                                                style: {
                                                    ...
                                                    border: "1px solid ".concat(n.auto ? "rgba(74,222,128,0.5)" : "rgba(234,179,8,0.4)")
                                                },
                                                children: n.title
                                            }, n.id, false, {
                                                fileName: "[project]/src/app/dashboard/snooks/page.tsx",
                                        ...
                                        notes4day.length > 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-[8px] text-black/30 px-1",
                                            children: [
                                                "+",
                                                notes4day.length - 2,
                                                " more"
                                ...
                                notes4day.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: (e)=>{
                                        e.stopPropagation();
                                        onDayClick(day);
                                    },
...
_c = CalendarGrid;
/* ─── Liquid glass bar ─── */ function LiquidGlassBar(param) {
    let { children } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_c1 = LiquidGlassBar;
/* ─── Note Modal (view / edit / delete) ─── */ function NoteModal(param) {
    let { note, onClose, onSave, onDelete } = param;
    _s();
    ...
    const [text, setText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(note.text);
    const save = ()=>{
        onSave({
            ...note,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "font-pixel text-black/60",
                                style: {
                                    fontSize: 8
                                },
                                children: [
                                    ...
                                    note.year,
                                    " · ",
                                    note.auto ? "AUTO-SCHEDULED" : "PLANNED"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/src/app/dashboard/snooks/page.tsx",
                                lineNumber: 309,
...
_s(NoteModal, "ReA3k0/KRO7skWqaC5oE9Z38/p4=");
_c2 = NoteModal;
/* ─── Add Note Modal ─── */ function AddNoteModal(param) {
    let { day, month, year, onClose, onAdd } = param;
    _s1();
...
_s1(AddNoteModal, "CK0Xj8E/e+j/Ei6ec+EST3ick6k=");
_c3 = AddNoteModal;
function SnooksPage() {
    _s2();
    const today = new Date();
    ...
    const [addDay, setAddDay] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const persistSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SnooksPage.useCallback[persistSession]": (msgs, sid)=>{
            const real = msgs.filter({
                "SnooksPage.useCallback[persistSession].real": (m)=>m.id !== "init"
            }["SnooksPage.useCallback[persistSession].real"]);
            if (!real.length) return;
            setSessions({
                "SnooksPage.useCallback[persistSession]": (prev)=>{
                    const exists = prev.find({
                        "SnooksPage.useCallback[persistSession].exists": (s)=>s.id === sid
                    }["SnooksPage.useCallback[persistSession].exists"]);
                    const first = real.find({
                        "SnooksPage.useCallback[persistSession].first": (m)=>m.role === "user"
                    }["SnooksPage.useCallback[persistSession].first"]);
                    const next = exists ? prev.map({
                        "SnooksPage.useCallback[persistSession]": (s)=>s.id === sid ? {
                                ...s,
                                messages: msgs
                            } : s
                    }["SnooksPage.useCallback[persistSession]"]) : [
                        {
                            id: sid,
    ...
    const send = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SnooksPage.useCallback[send]": async (text)=>{
            ...
            if (intent) {
                ...
                setYear(intent.year);
                const reply = "Done! I've added **\"".concat(intent.title, '"** to your calendar on ').concat(MONTHS[intent.month], " ").concat(intent.day, ". You'll see it as a green note on that date. Want me to flesh out the content for that post?");
                const botMsg = {
            ...
            try {
                const history = messages.filter({
                    "SnooksPage.useCallback[send].history": (m)=>m.id !== "init"
                }["SnooksPage.useCallback[send].history"]).map({
                    "SnooksPage.useCallback[send].history": (m)=>({
                            role: m.role === "bot" ? "assistant" : "user",
                            content: m.content
                        })
                }["SnooksPage.useCallback[send].history"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Content Strategist · mention a date to auto-schedule"
                            }, void 0, false, {
                                fileName: "[project]/src/app/dashboard/snooks/page.tsx",
                                lineNumber: 605,
                                columnNumber: 11
                        ...
                        children: [
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: msg.content.replace(/\*\*(.*?)\*\*/g, "$1")
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/snooks/page.tsx",
                                                        lineNumber: 639,
                                                        columnNumber: 19
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "font-pixel-thin text-black/25 mt-2 text-center",
                                        style: {
                                            fontSize: 11
                                        },
                                        children: "Mention a date or day to auto-add to calendar · click any date to add a note manually"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/snooks/page.tsx",
                                        lineNumber: 687,
                                        columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CalendarGrid, {
                                    year: year,
                                    month: month,
                                    notes: notes,
                                    onNoteClick: setActiveNote,
                                    onDayClick: (day)=>setAddDay({
                                            day,
                                            month,
                                            year
                                        })
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Yellow = planned · Green = auto-scheduled by Snooks · hover a date to add manually"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/dashboard/snooks/page.tsx",
                                    lineNumber: 718,
                                    columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                children: activeNote && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NoteModal, {
                    note: activeNote,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                children: addDay && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AddNoteModal, {
                    day: addDay.day,
                    month: addDay.month,
                    year: addDay.year,
...
_s2(SnooksPage, "GEpOOfoFNu7upExqcy6NzAnAVYo=");
_c4 = SnooksPage;
var _c, _c1, _c2, _c3, _c4;
__turbopack_context__.k.register(_c, "CalendarGrid");
__turbopack_context__.k.register(_c1, "LiquidGlassBar");
__turbopack_context__.k.register(_c2, "NoteModal");
__turbopack_context__.k.register(_c3, "AddNoteModal");
__turbopack_context__.k.register(_c4, "SnooksPage");
...
//# sourceMappingURL=_2756fded._.js.map