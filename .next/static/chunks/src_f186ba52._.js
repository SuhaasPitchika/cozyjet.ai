...
var _process_env_NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID;
const firebaseConfig = {
    projectId: ("TURBOPACK compile-time value", "studio-9941557236-b9262"),
    appId: ("TURBOPACK compile-time value", "1:326839652598:web:d536047bef50a2f9375cd7"),
    apiKey: ("TURBOPACK compile-time value", "AIzaSyCNUUR0jzzWjotLGqBjDMcrYTob9oo-fA8"),
    authDomain: ("TURBOPACK compile-time value", "studio-9941557236-b9262.firebaseapp.com"),
    messagingSenderId: ("TURBOPACK compile-time value", "326839652598"),
    measurementId: (_process_env_NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID) !== null && _process_env_NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID !== void 0 ? _process_env_NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID : ""
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
function initializeFirebase() {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApps"])().length) {
        try {
            ...
            // Fallback to config object if environment variables aren't present
...
"[project]/src/contexts/replit-auth-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
const ReplitAuthContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
const REPLIT_SIGNOUT_KEY = 'replit_signed_out';
function ReplitAuthProvider(param) {
    let { children } = param;
    _s();
    const [replitUser, setReplitUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isReplitLoading, setIsReplitLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [signedOut, setSignedOut] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const fetchUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ReplitAuthProvider.useCallback[fetchUser]": async ()=>{
            try {
    ...
    }["ReplitAuthProvider.useCallback[fetchUser]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReplitAuthProvider.useEffect": ()=>{
            fetchUser();
        }
    }["ReplitAuthProvider.useEffect"], [
        fetchUser,
    ...
    const refetchReplitUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ReplitAuthProvider.useCallback[refetchReplitUser]": async ()=>{
            sessionStorage.removeItem(REPLIT_SIGNOUT_KEY);
            setIsReplitLoading(true);
            await fetchUser();
        }
    }["ReplitAuthProvider.useCallback[refetchReplitUser]"], [
        fetchUser
    ]);
    const signOutReplit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ReplitAuthProvider.useCallback[signOutReplit]": ()=>{
            sessionStorage.setItem(REPLIT_SIGNOUT_KEY, 'true');
            setReplitUser(null);
            setSignedOut(true);
        }
    }["ReplitAuthProvider.useCallback[signOutReplit]"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ReplitAuthContext.Provider, {
        value: {
            replitUser,
            isReplitLoading,
            refetchReplitUser,
        ...
        fileName: "[project]/src/contexts/replit-auth-context.tsx",
        lineNumber: 65,
        columnNumber: 5
    }, this);
}
_s(ReplitAuthProvider, "7EfUmQ5kapdeOviZoasOkxpsNeg=");
_c = ReplitAuthProvider;
function useReplitAuth() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(ReplitAuthContext);
    if (!ctx) throw new Error('useReplitAuth must be used within ReplitAuthProvider');
    return ctx;
}
_s1(useReplitAuth, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
__turbopack_context__.k.register(_c, "ReplitAuthProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f186ba52._.js.map