    ...
    <section ref={containerRef} className="relative h-[500vh] font-pixel bg-white">
      ...
      >
        ...
        >
          ...
          <div className="absolute top-[40%] right-[10%] w-[50vw] h-[50vw] bg-gray-100/60 blur-[160px] rounded-full" />
          <div className="absolute inset-0 opacity-[0.025]" style={{ backgroundImage: "radial-gradient(circle, #000 1px, transparent 0)", backgroundSize: "28px 28px" }} />
        </motion.div>
      </motion.div>
        ...
        <div className="sticky top-0 h-screen w-full flex flex-col lg:flex-row items-center justify-between px-6 lg:px-24 overflow-hidden z-10">
          ...
          <div className="relative w-full lg:w-1/2 h-full flex flex-col justify-center pointer-events-auto">
            <div className="relative h-[400px] w-full max-w-md mx-auto lg:mx-0">
              {STEPS.map((step, index) => (
                ...
                >
                  <div className="w-full max-w-[400px] p-10 border border-black/5 rounded-sm bg-white/95 backdrop-blur-2xl shadow-[30px_30px_70px_-20px_rgba(0,0,0,0.08)] relative">
          ...
          <div className="relative w-full lg:w-2/5 aspect-[3/4] flex items-center justify-center pointer-events-auto">
            <div className="relative w-full h-full max-h-[75vh]">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[130%] h-[130%] bg-white blur-[100px] rounded-full -z-10 opacity-90" />
              ...
              {/* Color layer (animated wipe) */}
              <motion.div className="absolute inset-0 z-10" style={{ clipPath }}>
                <Image
                  src="/jet-color.jpg"
                  alt="Jet Fighter"
                  fill
                  className="object-contain drop-shadow-[0_30px_80px_rgba(0,0,0,0.12)]"
                  priority
                  sizes="(max-width: 768px) 100vw, 40vw"
                />
              </motion.div>
